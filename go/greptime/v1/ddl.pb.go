...
type ModifyColumn struct {
	...
	Body       *ModifyColumnBody `protobuf:"bytes,2,opt,name=body,proto3" json:"body,omitempty"`
}
...
func (x *ModifyColumn) GetBody() *ModifyColumnBody {
	if x != nil {
		return x.Body
	}
	return nil
...
type ModifyColumnBody struct {
	...
	//
	//	*ModifyColumnBody_ModifyType
	//	*ModifyColumnBody_ModifyName
	Body isModifyColumnBody_Body `protobuf_oneof:"body"`
}

func (x *ModifyColumnBody) Reset() {
	*x = ModifyColumnBody{}
	if protoimpl.UnsafeEnabled {
...
func (x *ModifyColumnBody) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ModifyColumnBody) ProtoMessage() {}

func (x *ModifyColumnBody) ProtoReflect() protoreflect.Message {
	mi := &file_greptime_v1_ddl_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ModifyColumnBody.ProtoReflect.Descriptor instead.
func (*ModifyColumnBody) Descriptor() ([]byte, []int) {
	return file_greptime_v1_ddl_proto_rawDescGZIP(), []int{13}
}

func (m *ModifyColumnBody) GetBody() isModifyColumnBody_Body {
	if m != nil {
		return m.Body
	}
	return nil
...
func (x *ModifyColumnBody) GetModifyType() *ModifyColumnType {
	if x, ok := x.GetBody().(*ModifyColumnBody_ModifyType); ok {
		return x.ModifyType
	}
	return nil
}

func (x *ModifyColumnBody) GetModifyName() *ModifyColumnName {
	if x, ok := x.GetBody().(*ModifyColumnBody_ModifyName); ok {
		return x.ModifyName
	}
	return nil
}

type isModifyColumnBody_Body interface {
	isModifyColumnBody_Body()
}

type ModifyColumnBody_ModifyType struct {
	ModifyType *ModifyColumnType `protobuf:"bytes,1,opt,name=modify_type,json=modifyType,proto3,oneof"`
}

type ModifyColumnBody_ModifyName struct {
	ModifyName *ModifyColumnName `protobuf:"bytes,2,opt,name=modify_name,json=modifyName,proto3,oneof"`
}

func (*ModifyColumnBody_ModifyType) isModifyColumnBody_Body() {}

func (*ModifyColumnBody_ModifyName) isModifyColumnBody_Body() {}

type ModifyColumnName struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ModifyColumnName) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ModifyColumnName) ProtoMessage() {}

func (x *ModifyColumnName) ProtoReflect() protoreflect.Message {
	mi := &file_greptime_v1_ddl_proto_msgTypes[14]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ModifyColumnName.ProtoReflect.Descriptor instead.
func (*ModifyColumnName) Descriptor() ([]byte, []int) {
	return file_greptime_v1_ddl_proto_rawDescGZIP(), []int{14}
}

func (x *ModifyColumnName) GetTargetName() string {
	if x != nil {
		return x.TargetName
	}
	return ""
...
type ModifyColumnType struct {
	...
	TargetType          ColumnDataType           `protobuf:"varint,1,opt,name=target_type,json=targetType,proto3,enum=greptime.v1.ColumnDataType" json:"target_type,omitempty"`
	TargetTypeExtension *ColumnDataTypeExtension `protobuf:"bytes,2,opt,name=target_type_extension,json=targetTypeExtension,proto3" json:"target_type_extension,omitempty"`
}
...
var file_greptime_v1_ddl_proto_rawDesc = []byte{
	...
	0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x62, 0x0a, 0x0c, 0x4d, 0x6f, 0x64, 0x69, 0x66, 0x79,
	...
	0x75, 0x6d, 0x6e, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x31, 0x0a, 0x04, 0x62, 0x6f, 0x64, 0x79, 0x18,
	...
	0x42, 0x6f, 0x64, 0x79, 0x52, 0x04, 0x62, 0x6f, 0x64, 0x79, 0x22, 0x9e, 0x01, 0x0a, 0x10, 0x4d,
	0x6f, 0x64, 0x69, 0x66, 0x79, 0x43, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x42, 0x6f, 0x64, 0x79, 0x12,
	0x40, 0x0a, 0x0b, 0x6d, 0x6f, 0x64, 0x69, 0x66, 0x79, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01,
	...
	0x79, 0x70, 0x65, 0x48, 0x00, 0x52, 0x0a, 0x6d, 0x6f, 0x64, 0x69, 0x66, 0x79, 0x54, 0x79, 0x70,
	0x65, 0x12, 0x40, 0x0a, 0x0b, 0x6d, 0x6f, 0x64, 0x69, 0x66, 0x79, 0x5f, 0x6e, 0x61, 0x6d, 0x65,
	...
	0x6e, 0x4e, 0x61, 0x6d, 0x65, 0x48, 0x00, 0x52, 0x0a, 0x6d, 0x6f, 0x64, 0x69, 0x66, 0x79, 0x4e,
	0x61, 0x6d, 0x65, 0x42, 0x06, 0x0a, 0x04, 0x62, 0x6f, 0x64, 0x79, 0x22, 0x33, 0x0a, 0x10, 0x4d,
	0x6f, 0x64, 0x69, 0x66, 0x79, 0x43, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x4e, 0x61, 0x6d, 0x65, 0x12,
	...
	0x22, 0xaa, 0x01, 0x0a, 0x10, 0x4d, 0x6f, 0x64, 0x69, 0x66, 0x79, 0x43, 0x6f, 0x6c, 0x75, 0x6d,
	0x6e, 0x54, 0x79, 0x70, 0x65, 0x12, 0x3c, 0x0a, 0x0b, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x5f,
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x02, 0x69, 0x64, 0x22, 0xd8, 0x02, 0x0a, 0x09, 0x43,
	...
	0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0xb7, 0x01, 0x0a, 0x11, 0x41, 0x64, 0x64, 0x43, 0x6f, 0x6c,
	...
	0x53, 0x54, 0x10, 0x00, 0x12, 0x09, 0x0a, 0x05, 0x41, 0x46, 0x54, 0x45, 0x52, 0x10, 0x01, 0x42,
...
var file_greptime_v1_ddl_proto_goTypes = []interface{}{
	...
	(*ModifyColumnBody)(nil),            // 14: greptime.v1.ModifyColumnBody
	(*ModifyColumnName)(nil),            // 15: greptime.v1.ModifyColumnName
	(*ModifyColumnType)(nil),            // 16: greptime.v1.ModifyColumnType
	(*DropColumn)(nil),                  // 17: greptime.v1.DropColumn
	(*TableId)(nil),                     // 18: greptime.v1.TableId
	...
	(ColumnDataType)(0),                 // 23: greptime.v1.ColumnDataType
	(*ColumnDataTypeExtension)(nil),     // 24: greptime.v1.ColumnDataTypeExtension
	(SemanticType)(0),                   // 25: greptime.v1.SemanticType
}
var file_greptime_v1_ddl_proto_depIdxs = []int32{
	...
	19, // 5: greptime.v1.CreateTableExpr.column_defs:type_name -> greptime.v1.ColumnDef
	21, // 6: greptime.v1.CreateTableExpr.table_options:type_name -> greptime.v1.CreateTableExpr.TableOptionsEntry
	18, // 7: greptime.v1.CreateTableExpr.table_id:type_name -> greptime.v1.TableId
	...
	18, // 12: greptime.v1.DropTableExpr.table_id:type_name -> greptime.v1.TableId
	22, // 13: greptime.v1.CreateDatabaseExpr.options:type_name -> greptime.v1.CreateDatabaseExpr.OptionsEntry
	18, // 14: greptime.v1.TruncateTableExpr.table_id:type_name -> greptime.v1.TableId
	12, // 15: greptime.v1.AddColumns.add_columns:type_name -> greptime.v1.AddColumn
	17, // 16: greptime.v1.DropColumns.drop_columns:type_name -> greptime.v1.DropColumn
	13, // 17: greptime.v1.ModifyColumns.modify_columns:type_name -> greptime.v1.ModifyColumn
	19, // 18: greptime.v1.AddColumn.column_def:type_name -> greptime.v1.ColumnDef
	20, // 19: greptime.v1.AddColumn.location:type_name -> greptime.v1.AddColumnLocation
	14, // 20: greptime.v1.ModifyColumn.body:type_name -> greptime.v1.ModifyColumnBody
	16, // 21: greptime.v1.ModifyColumnBody.modify_type:type_name -> greptime.v1.ModifyColumnType
	15, // 22: greptime.v1.ModifyColumnBody.modify_name:type_name -> greptime.v1.ModifyColumnName
	23, // 23: greptime.v1.ModifyColumnType.target_type:type_name -> greptime.v1.ColumnDataType
	24, // 24: greptime.v1.ModifyColumnType.target_type_extension:type_name -> greptime.v1.ColumnDataTypeExtension
	23, // 25: greptime.v1.ColumnDef.data_type:type_name -> greptime.v1.ColumnDataType
	25, // 26: greptime.v1.ColumnDef.semantic_type:type_name -> greptime.v1.SemanticType
	24, // 27: greptime.v1.ColumnDef.datatype_extension:type_name -> greptime.v1.ColumnDataTypeExtension
	0,  // 28: greptime.v1.AddColumnLocation.location_type:type_name -> greptime.v1.AddColumnLocation.LocationType
...
func file_greptime_v1_ddl_proto_init() {
	...
	file_greptime_v1_ddl_proto_msgTypes[13].OneofWrappers = []interface{}{
		(*ModifyColumnBody_ModifyType)(nil),
		(*ModifyColumnBody_ModifyName)(nil),
	}
	type x struct{}
