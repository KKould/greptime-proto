...
type ModifyColumn struct {
	...
	//
	//	*ModifyColumn_ModifyType
	//	*ModifyColumn_ModifyName
	Body isModifyColumn_Body `protobuf_oneof:"body"`
}
...
func (m *ModifyColumn) GetBody() isModifyColumn_Body {
	if m != nil {
		return m.Body
	}
	return nil
...
func (x *ModifyColumn) GetModifyType() *ModifyColumnType {
	if x, ok := x.GetBody().(*ModifyColumn_ModifyType); ok {
		return x.ModifyType
	}
	return nil
}

func (x *ModifyColumn) GetModifyName() *ModifyColumnName {
	if x, ok := x.GetBody().(*ModifyColumn_ModifyName); ok {
		return x.ModifyName
	}
	return nil
}

type isModifyColumn_Body interface {
	isModifyColumn_Body()
}

type ModifyColumn_ModifyType struct {
	ModifyType *ModifyColumnType `protobuf:"bytes,2,opt,name=modify_type,json=modifyType,proto3,oneof"`
}

type ModifyColumn_ModifyName struct {
	ModifyName *ModifyColumnName `protobuf:"bytes,3,opt,name=modify_name,json=modifyName,proto3,oneof"`
}

func (*ModifyColumn_ModifyType) isModifyColumn_Body() {}

func (*ModifyColumn_ModifyName) isModifyColumn_Body() {}
...
var file_greptime_v1_ddl_proto_rawDesc = []byte{
	...
	0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xbb, 0x01, 0x0a, 0x0c, 0x4d, 0x6f, 0x64, 0x69, 0x66,
	...
	,
...
var file_greptime_v1_ddl_proto_goTypes = []interface{}{
	...
	(*ModifyColumnName)(nil),            // 14: greptime.v1.ModifyColumnName
	(*ModifyColumnType)(nil),            // 15: greptime.v1.ModifyColumnType
	...
	(SemanticType)(0),                   // 24: greptime.v1.SemanticType
}
var file_greptime_v1_ddl_proto_depIdxs = []int32{
	...
	18, // 5: greptime.v1.CreateTableExpr.column_defs:type_name -> greptime.v1.ColumnDef
	20, // 6: greptime.v1.CreateTableExpr.table_options:type_name -> greptime.v1.CreateTableExpr.TableOptionsEntry
	17, // 7: greptime.v1.CreateTableExpr.table_id:type_name -> greptime.v1.TableId
	...
	17, // 12: greptime.v1.DropTableExpr.table_id:type_name -> greptime.v1.TableId
	21, // 13: greptime.v1.CreateDatabaseExpr.options:type_name -> greptime.v1.CreateDatabaseExpr.OptionsEntry
	17, // 14: greptime.v1.TruncateTableExpr.table_id:type_name -> greptime.v1.TableId
	12, // 15: greptime.v1.AddColumns.add_columns:type_name -> greptime.v1.AddColumn
	16, // 16: greptime.v1.DropColumns.drop_columns:type_name -> greptime.v1.DropColumn
	13, // 17: greptime.v1.ModifyColumns.modify_columns:type_name -> greptime.v1.ModifyColumn
	18, // 18: greptime.v1.AddColumn.column_def:type_name -> greptime.v1.ColumnDef
	19, // 19: greptime.v1.AddColumn.location:type_name -> greptime.v1.AddColumnLocation
	15, // 20: greptime.v1.ModifyColumn.modify_type:type_name -> greptime.v1.ModifyColumnType
	14, // 21: greptime.v1.ModifyColumn.modify_name:type_name -> greptime.v1.ModifyColumnName
	22, // 22: greptime.v1.ModifyColumnType.target_type:type_name -> greptime.v1.ColumnDataType
	23, // 23: greptime.v1.ModifyColumnType.target_type_extension:type_name -> greptime.v1.ColumnDataTypeExtension
	22, // 24: greptime.v1.ColumnDef.data_type:type_name -> greptime.v1.ColumnDataType
	24, // 25: greptime.v1.ColumnDef.semantic_type:type_name -> greptime.v1.SemanticType
	23, // 26: greptime.v1.ColumnDef.datatype_extension:type_name -> greptime.v1.ColumnDataTypeExtension
	0,  // 27: greptime.v1.AddColumnLocation.location_type:type_name -> greptime.v1.AddColumnLocation.LocationType
...
func file_greptime_v1_ddl_proto_init() {
	...
	file_greptime_v1_ddl_proto_msgTypes[12].OneofWrappers = []interface{}{
		(*ModifyColumn_ModifyType)(nil),
		(*ModifyColumn_ModifyName)(nil),
	}
	type x struct{}
